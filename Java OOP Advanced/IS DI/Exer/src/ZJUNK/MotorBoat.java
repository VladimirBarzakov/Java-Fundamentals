...
public final class MotorBoat implements Modelable {
    ...
    public void setSailEfficiency(int sailEfficiency) {
        if (sailEfficiency < 1 || sailEfficiency > 100) {
            throw new IllegalArgumentException(Constants.SAIL_EFFECTIVENESS_MUST_BE_BETWEEN_1_100);
        }
    ...
    public double CalculateRaceSpeed(Race race) {
        ...
        //    var speed = this.JetEngine.Sum(x = > x.Output)+this.SterndriveEngine.Sum(x = > x.Output)
